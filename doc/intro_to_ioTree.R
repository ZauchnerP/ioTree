...
path <- system.file("extdata/exp_data_5.4.0", package = "ioTree")

# Import without specifications
# Import all oTree files in this folder and its subfolders
otree <- ioTree::import_otree(path = path)
...
otree_all <- ioTree::import_otree(
  path = system.file("extdata", package = "ioTree"))
