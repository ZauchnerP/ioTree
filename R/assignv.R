...
#' @param variable Character. The variable in the all_apps_wide data frame that
#' should be assigned to all other apps.
...
assignv <- function(oTree,
  ...
  if (!(variable %in% colnames(oTree[["all_apps_wide"]]))) {
    stop(paste0("The variable does not exist in  \"all_apps_wide\"!"))
  }
