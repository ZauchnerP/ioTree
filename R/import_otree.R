#' Import oTree data
#' @description
#' Import everything that was created by oTree.
...
#'
#' Warning! Data can be downloaded from within the
...
#'
#' Warning! Importing Excel files does not check for erroneous data structures
#' and will add all data frames with the same file name patterns
#' together. Clean your data properly before using the "CSV = FALSE" argument.
#' @keywords oTree
...
#' @param encoding Characters. Encoding of the CSV files that are imported.
#' Default is "UTF-8".
#' @param path Characters. The path to the files (default is the
#' working directory).
